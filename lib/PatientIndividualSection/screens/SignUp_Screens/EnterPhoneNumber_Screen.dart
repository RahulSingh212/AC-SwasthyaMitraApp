...
class EnterPatientPhoneNumberScreen extends StatefulWidget {
  static const routeName = '/patient-enter-phone-number-screen';

  @override
  State<EnterPatientPhoneNumberScreen> createState() =>
      _EnterPatientPhoneNumberScreenState();
}

class _EnterPatientPhoneNumberScreenState extends State<EnterPatientPhoneNumberScreen> {
                  ...
                  if (Provider.of<PatientAuthDetails>(context, listen: false)
                    ...
                    if ((await Provider.of<PatientAuthDetails>(context,
                      ...
                      Navigator.of(context)
                          .pushNamed(EnterPatientPhoneOtpScreen.routeName);
                    } else {
                      String titleText = isLangEnglish
                          ? "Un-Identified User!"
                          : "अज्ञात उपयोगकर्ता!";
