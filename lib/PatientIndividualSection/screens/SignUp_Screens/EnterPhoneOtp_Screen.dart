// ignore_for_file: unnecessary_this, use_key_in_widget_constructors, unused_field, prefer_final_fields, prefer_const_constructors, use_build_context_synchronously, deprecated_member_use, prefer_const_literals_to_create_immutables, unused_import, must_be_immutable, unused_local_variable, duplicate_ignore
...
class EnterPatientPhoneOtpScreen extends StatefulWidget {
  ...
  // EnterPatientPhoneOtpScreen(this.enteredPhoneNumber);

  @override
  State<EnterPatientPhoneOtpScreen> createState() =>
      _EnterPatientPhoneOtpScreenState();
}

class _EnterPatientPhoneOtpScreenState
    extends State<EnterPatientPhoneOtpScreen> {
