...
import 'PatientFiltered_Screen.dart';

class FindAndAddPatientScreenSwasthyaMitra extends StatefulWidget {
  static const routeName = 'swasthya-mitra-find-and-add-patient-screen';

  @override
  State<FindAndAddPatientScreenSwasthyaMitra> createState() =>
      _FindAndAddPatientScreenSwasthyaMitraState();
}

class _FindAndAddPatientScreenSwasthyaMitraState
    extends State<FindAndAddPatientScreenSwasthyaMitra> {
  ...
  void didChangeDependencies() {
    ...
    isAuthorized = Provider.of<SwasthyaMitraUserDetails>(context, listen: false)
            .mp['SwasthyaMitra_AutherizationStatus'] ==
        "true";

    userMapping = Provider.of<SwasthyaMitraUserDetails>(context, listen: false)
        .getSwasthyaMitraUserPersonalInformation();

    isAuthorized = userMapping['SwasthyaMitra_AuthorizationStatus'] == 'true';
  }
    ...
    return InkWell(
      onTap: () {
        if (patientDetails.patient_ProfilePermission) {
          // Navigator.of(context).push(
          //   MaterialPageRoute(
          //     builder: (context) => PatientHomeScreenSwasthyaMitra(
          //       2,
          //       patientDetails,
          //     ),
          //   ),
