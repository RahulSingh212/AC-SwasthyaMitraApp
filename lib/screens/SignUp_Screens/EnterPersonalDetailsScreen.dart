// ignore_for_file: prefer_const_constructors, unused_element, unused_local_variable, unused_import
...
class EnterUserPersonalDetailsScreen extends StatefulWidget {
  static const routeName = 'swasthya-mitra-personal-details-screen';
...
class _EnterUserPersonalDetailsScreenState
  ...
  void initState() {
    ...
    isLangEnglish = Provider.of<SwasthyaMitraUserDetails>(context, listen: false)
      ...
      body: Stack(
        children: [
          ...
          Container(
            ...
            child: Text(
              isLangEnglish
                  ? "Please enter your Center's Name"
                  : "कृपया अपने केंद्र का नाम दर्ज करें",
              style: TextStyle(
                fontFamily: 'Roboto',
              ...
              onPressed: () {
                if (_userFullName.text.isEmpty ||
                  ...
                  Provider.of<SwasthyaMitraUserDetails>(context, listen: false)
                      .setSwasthyaMitraCenterName(_userFullName);
